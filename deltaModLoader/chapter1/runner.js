...
var J, K, Ib = {
    ...
    1552246: (a, b, c, d, e) => {
        gxc_request_room(a ? x(v, a) : "", b ? x(v, b) : "", c, d ? x(v, d) : "", e ? x(v, e) : "")
    },
    1552344: (a, b, c, d) => {
    ...
    1560660: (a, b, c, d) => {
        ...
        null == e.$i && (e.$i = document.createElement("canvas"), e.$i.style.cssText = "position:fixed; top:1px; left:1px; width:1px; height:1px", e.$i.width = a, e.$i.height = b, document.body.appendChild(e.$i), console.log("Game Canvas width:" + e.width + " height:" + e.height), e.el = e.$i.getContext("2d", {
            ...
            powerPreference: "low-power",
            preserveDrawingBuffer: !0
        }), e.mj = document.createElement("video"), e.mj.autoplay = !0, e.mj.Wl = !0, e.mj.muted = !0, e.mj.style.cssText = "position:fixed;top:1px;left:1px;width:1px;height:1px", document.body.appendChild(e.mj), e.mj.srcObject = e.Hk, a = e.$i.captureStream(c), 0 < d && (d = da.createMediaStreamDestination().stream.getAudioTracks().find(g => g.enabled), a.addTrack(d)), f = new MediaRecorder(a, f), e.ej = [], f.ondataavailable = function(g) {
            e.ej.push(g.data)
        }, e.Gi = f);
    ...
    1574754: () => {
        Cb("/_savedata");
        window.oprt && window.oprt.gameStorage ? Db(GXMFS, "/_savedata") : Db(L, "/_savedata");
        Eb(!0, function() {
    ...
    1579178: a => {
        ...
        if (a) {
            ...
            b.capture = void 0
        } else void 0 != b.audio.Mi && (b.audio.Mi.disconnect(), b.audio.Mi = void 0), b.audio = void 0;
...
var y = {
        ...
        Bi: {
            ...
            Ni(a, b) {
                ...
                if (void 0 !== b.size && (b = b.size, a.Fi != b))
                    if (0 == b) a.Ci = null, a.Fi = 0;
                        ...
                        c && a.Ci.set(c.subarray(0, Math.min(b, a.Fi)));
                        a.Fi = b
                    }
            },
            lookup() {
            ...
            readdir(a) {
                var b = [".", ".."],
                    c;
                for (c in a.Ci) a.Ci.hasOwnProperty(c) && b.push(c);
                return b
            },
            symlink(a, b, c) {
        ...
        Di: {
            ...
            write(a, b, c, d, e, f) {
                ...
                if (b.subarray && (!a.Ci || a.Ci.subarray)) {
                    if (f) return a.Ci = b.subarray(c, c + d), a.Fi = d;
...
function Sc(a, b, c) {
    ...
    if (!d && (c = e ? 40960 === (e.mode & 61440) ? 32 : B(e.mode) && ("r" !== Gc(b) || b & 512) ? 31 : Ec(e, Gc(b)) : 44)) throw new O(c);
    if (b & 512 && !d) {
        c = e;
...
function cd(a, b, c, d, e) {
    ...
    f.prototype.Kk = function() {
        ...
        var u = Number(q.getResponseHeader("Content-length")),
            w, r = (w = q.getResponseHeader("Accept-Ranges")) && "bytes" === w;
...
function fd(a, b, c, d, e, f) {
    ...
    b = b.slice(c, c + d);
    if (2 === a.type && (!g || g.socket.readyState !== g.socket.OPEN)) return g && g.socket.readyState !== g.socket.CLOSING && g.socket.readyState !== g.socket.CLOSED || (g = gd(a, e, f)), g.Nj.push(b), d;
    try {
...
function hd(a, b) {
    ...
    function d(f) {
        ...
        var g = e;
        e = !1;
        g && 10 === f.length && 255 === f[0] && 255 === f[1] && 255 === f[2] && 255 === f[3] && 112 === f[4] && 111 === f[5] && 114 === f[6] && 116 === f[7] ? (f = f[8] << 8 | f[9], delete a.Yi[b.Hi + ":" + b.port], b.port = f, a.Yi[b.Hi + ":" + b.port] = b) : (a.xj.push({
            Hi: b.Hi,
            port: b.port,
            data: f
...
var jd = {
        ...
        Tl: {
            Zk(a) {
                ...
                if (a.xj.length || !c || c && c.socket.readyState === c.socket.CLOSING || c && c.socket.readyState === c.socket.CLOSED) b |= 65;
    ...
    ld = a => (a & 255) + "." + (a >> 8 & 255) + "." + (a >> 16 & 255) + "." + (a >> 24 & 255),
    nd = a => {
        var b = "",
            c, d = 0,
            e = 0,
...
function yd(a, b, c) {
    ...
    K = [Math.floor(a / 1E3) >>> 0, (J = Math.floor(a / 1E3), 1 <= +Math.abs(J) ? 0 < J ? +Math.floor(J / 4294967296) >>> 0 : ~~+Math.ceil((J - +(~~J >>> 0)) / 4294967296) >>> 0 : 0)];
    E[c + 40 >> 2] = K[0];
    E[c + 44 >> 2] = K[1];
    G[c + 48 >> 2] = a % 1E3 * 1E3;
...
var vf = {},
    ...
    Uf = (a, b) => {
        if (0 != b.zk || 0 != b.fk) {
            Rf(a);
            var c = b.Kl ? innerWidth : screen.width,
            ...
            a.style.width = c + "px";
            a.style.height = d + "px";
            1 == b.tl && (a.style.hj = "optimizeSpeed", a.style.hj = "-moz-crisp-edges", a.style.hj = "-o-crisp-edges", a.style.hj = "-webkit-optimize-contrast", a.style.hj = "optimize-contrast", a.style.hj = "crisp-edges", a.style.hj = "pixelated");
...
var Jg = a => {
    ...
    Mg = (a, b, c, d, e) => {
        Q.framebufferTexture2D(a, b, c, Ie[d], e)
    };
...
var Ug = (a, b, c, d, e, f, g, h) => {
    ...
    eh = (a, b, c) => {
        if (c) {
            a = Le[a];
            b = 2 > P.version ? Q.Si.getQueryObjectEXT(a, b) : Q.getQueryParameter(a, b);
            var d;
    ...
    hh = (a, b, c) => {
        c ? 35716 == b ? (a = Q.getShaderInfoLog(Je[a]), null === a && (a = "(unknown error)"), E[c >> 2] = a ? a.length + 1 : 0) : 35720 == b ? (a = Q.getShaderSource(Je[a]), E[c >> 2] = a ? a.length + 1 : 0) : E[c >> 2] = Q.getShaderParameter(Je[a], b) : V(1281)
    },
    ih = a => {
        var b = Qe[a];
        if (!b) {
    ...
    ph = a => (a = Ke[a]) ? Q.isVertexArray(a) : 0,
    qh = a => {
        a = U[a];
        Q.linkProgram(a);
        a.Jj = 0;
    ...
    uh = (a, b, c, d, e, f, g) => {
        if (2 <= P.version)
            if (Q.hk) Q.readPixels(a, b, c, d, e, f, g);
            else {
                var h = sh(f);
    ...
    gi = (a, b, c, d, e, f) => {
        ...
        return rf({
            ...
            Qi: g => {
                ...
                for (q = 0; q < g.changedTouches.length; ++q) h = g.changedTouches[q], h.Tk = 1, n[h.identifier] = h;
...
function ni(a, b, c, d, e) {
    ...
    if (g) {
        ...
        F.onload = Y => {
            li.has(T) && (f(), 200 <= F.status && 300 > F.status ? b && b(a, F, Y) : c && c(a, F, Y))
        };
        F.onerror = Y => {
    ...
    yi = (a, b, c, d) => {
        ...
        p = {
            ...
            "%V": r => {
                ...
                if (A) 53 == A && (z = (r.Zi + 371 - r.rj) % 7, 4 == z || 3 == z && Cd(r.sj) || (A = 1));
                else {
                    A = 52;
...
var Gi = {
            ...
            try {
                ...
                for (var e = Vc(d, 0, 1), f = Math.floor(e / 280); f < d.pj.length && a + 280 <= c;) {
                    ...
                    if ("." === g) {
                        ...
                        var p = jc(d.node, g);
                        h = p.id;
                        n = 8192 === (p.mode & 61440) ? 2 : B(p.mode) ? 4 : 40960 === (p.mode & 61440) ? 10 : 8
                    }
        ...
        Ab: function(a, b, c, d, e, f) {
            try {
                ...
                return h ? fd(g, C, b, c, h.Hi, h.port) : Wc(g.stream, C, b, c)
            } catch (q) {
                if ("undefined" == typeof dd || "ErrnoError" !== q.name) throw q;
                return -q.Ei
            }
        ...
        Eb: (a, b, c) => {
            ...
            a = Fd(a);
            b = Fd(b);
            h < e ? (G[c >> 2] = a, G[c + 4 >> 2] = b) : (G[c >> 2] = b, G[c + 4 >> 2] = a)
        },
        q: () => {
            $a("")
        },
        ...
        Ch: (a, b, c, d, e) => {
            if (62E3 != a) R = 12296, c = 0;
                ...
                c && d || e ? (e && (E[e >> 2] = 1), c && 0 < d && (G[c >> 2] = 62002), R = 12288, c = 1) : (R = 12300, c = 0)
            }
            return c
        },
        ph: (a, b, c, d) => {
        ...
        Dh: (a, b, c, d) => {
            ...
            switch (c) {
                ...
                case 12338:
                    return E[d >> 2] = xe.antialias ? 1 : 0, 1;
                case 12339:
                    return E[d >> 2] = 4, 1;
                case 12340:
                    return E[d >> 2] = 12344, 1;
        ...
        Jg: (a, b, c) => {
            Q.bindAttribLocation(U[a], b, c ? x(v, c) : "")
        },
        Ig: Zf,
        od: (a, b, c) => {
        ...
        yg: fg,
        xg: (a, b, c, d) => {
            2 <= P.version ? c && Q.bufferSubData(a, b, v, d, c) : Q.bufferSubData(a, b, v.subarray(d, d + c))
        },
        wg: function(a) {
        ...
        qg: lg,
        pg: (a, b, c, d, e, f, g, h) => {
            2 <= P.version ? Q.Vi || !g ? Q.compressedTexImage2D(a, b, c, d, e, f, g, h) : Q.compressedTexImage2D(a, b, c, d, e, f, v, h, g) : Q.compressedTexImage2D(a, b, c, d, e, f, h ? v.subarray(h, h + g) : null)
        },
        ...
        xd: (a, b, c) => {
            if (Kg(a)) {
                var d = Fe[Jg(a)];
                d ? d.Ik & 16 ? 0 > b || 0 > c || b + c > d.length ? (V(1281), l("invalid range in glFlushMappedBufferRange")) : Q.bufferSubData(a, d.offset, v.subarray(d.cj + b, d.cj + b + c)) : (V(1282), l("buffer was not mapped with GL_MAP_FLUSH_EXPLICIT_BIT in glFlushMappedBufferRange")) : (V(1282), l("buffer was never mapped in glFlushMappedBufferRange"))
        ...
        Cc: (a, b, c, d, e) => {
            0 > c ? V(1281) : e ? (a = Q.getSyncParameter(Oe[a], b), null !== a && (E[e >> 2] = a, d && (E[d >> 2] = 1))) : V(1281)
        },
        rf: (a, b, c) => {
        ...
        dc: (a, b, c, d, e, f, g) => {
            for (var h = Cg[b], n = 0; n < b; n++) h[n] = E[c + 4 * n >> 2];
        ...
        tc: (a, b, c) => {
            Q.samplerParameteri(Me[a], b, E[c >> 2])
        },
        Ue: wh,
        Te: () => {
            V(1280)
        ...
        ne: Sh,
        Ed: (a, b, c, d) => {
            b && Q.uniformMatrix4x2fv(W(a), !!c, H, d >> 2, 8 * b)
        },
        Cd: (a, b, c, d) => {
        ...
        Ta: () => (wf = navigator.getGamepads ? navigator.getGamepads() : navigator.webkitGetGamepads ? navigator.webkitGetGamepads() : null) ? 0 : -1,
        ...
        Ra: (a, b, c) => navigator.getGamepads || navigator.webkitGetGamepads ? ai(a, b, c, 26, "gamepadconnected") : -1,
        ...
        Q: (a, b, c, d) => di(a, b, c, d, 6, "mouseup"),
        Ka: (a, b, c, d) => {
        ...
        M: (a, b, c, d) => gi(a, b, c, d, 22, "touchstart"),
...
"undefined" != typeof window && (api_error_callback = k.cwrap("api_error_callback", null, ["number", "string"]), create_game_callback = k.cwrap("create_game_callback", null, ["string", "string", "string"]), join_game_callback = k.cwrap("join_game_callback", null, ["string"]), chat_callback = k.cwrap("chat_callback", null, ["string", "number"]), player_info_callback = k.cwrap("player_info_callback", null, "number string string string bool string".split(" ")), log_next_game_state = k.cwrap("log_next_game_state", null, []), start_game = k.cwrap("start_game", null, []), init_request_parameters = a => {
    ...
    fetch("https://" + a + "/gg/games/" + d + "/rooms" + (e.length ? "?trackId=" + e : ""), b).then(h => {
        h.ok ? h.json().then(n => {
            ...
            f ? (p = location.protocol + "//" + location.host + location.pathname + "?game=debug&roomUrl=" + q, set_local_share_url(p)) : post_share_url(p);
    ...
    fetch("https://" + a + "/gg/rooms?roomUrl=" + c, d).then(f => {
        f.ok ? f.json().then(g => {
            ...
            gxc_player_info.forEach(h => {
                null !== h.playerId && (null === h.user ? (h.user = {}, h.user.username = "unknown", h.user.avatarUrl = e, h.user.userId = "", h.user.guest = !0) : (null === h.user.avatarUrl && (h.user.avatarUrl = e), h.user.guest = !1))
            });
            window.parent && (g = {
                type: "players"
