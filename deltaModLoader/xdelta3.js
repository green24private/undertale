var createXdelta3Module = (() => {
    var _scriptDir = import.meta.url;
    return (function(createXdelta3Module) {
        createXdelta3Module = createXdelta3Module || {};
        var Module = typeof createXdelta3Module != "undefined" ? createXdelta3Module : {};
        ...
        var wasmBinaryFile;
        if (Module["locateFile"]) {
            wasmBinaryFile = "xdelta3.wasm";
            if (!isDataURI(wasmBinaryFile)) {
                wasmBinaryFile = locateFile(wasmBinaryFile)
            }
        } else {
            wasmBinaryFile = new URL("xdelta3.wasm", import.meta.url).toString()
        }
        ...
        var tempI64;
        var ASM_CONSTS = {
            30740: function($0, $1, $2) {
                return Module.readSource($0, $1, $2)
            },
            30782: function($0, $1, $2) {
                return Module.readPatch($0, $1, $2)
            },
            30823: function($0, $1) {
                Module.outputFile($0, $1)
            },
            30851: function($0) {
                Module.reportError($0)
            }
        };
        ...
        run();
        return createXdelta3Module.ready
    });
})();
export default createXdelta3Module;
